...
export const historyPanelVisibleStorageKey = 'tc-translate-history-panel-visible-v1'
...
export const translateAutoCopyStorageKey = 'tc-translate-translate-auto-copy-v1'
export const translateAutoBackCheckStorageKey = 'tc-translate-translate-auto-back-check-v1'
