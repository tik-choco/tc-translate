...
export async function explainText(params: {
  ...
  const brevity = params.settings.performanceMode !== 'normal'
    ? ' Be brief: "overview" at most 2 sentences, at most 3 "grammarPoints", and at most 6 "vocabulary" entries, choosing the most important ones.'
    : ''
